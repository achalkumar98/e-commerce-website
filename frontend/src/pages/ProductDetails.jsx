        ...
        <div className="h-96 flex flex-col lg:flex-row-reverse gap-4">
          <div className="h-[300px] w-[300px] lg:h-96 lg:w-96 bg-slate-200 relative p-2">
            {activeImage ? (
              ...
              <div className="h-full w-full flex items-center justify-center bg-slate-300 text-gray-500">
                No Image
              </div>
            )}
        ...
        {loading ? (
          <div className="grid gap-1 w-full">
            ...
            {Array(6).fill(0).map((_, i) => (
              <div key={"skeleton_" + i} className="bg-slate-200 animate-pulse h-6 lg:h-8 w-full rounded-full my-1"></div>
            ))}
          </div>
        ) : (
